    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('kasbon/save');?>" method="post" autocomplete="off">
                        <?= csrf_field();?>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control <?= !empty($rusak['jumlah']) ? 'is-invalid' : ''; ?>"
                                        name="jumlah" id="jumlah" value="<?= old('jumlah');?>" placeholder="Contoh: 100000">
                                    <small class="invalid-feedback">
                                        <?= !empty($rusak['jumlah']) ? validation_show_error('jumlah') : ''; ?>
                                    </small>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" id="keterangan"
                                        class="form-control <?= !empty($rusak['keterangan']) ? 'is-invalid' : ''; ?>"
                                        placeholder="Alasan pengajuan kasbon"><?= old('keterangan');?></textarea>
                                    <small class="invalid-feedback">
                        ...
                        <div>
                            ...
                            <a href="<?= base_url('kasbon');?>" class="btn btn-info">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
