            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="<?= base_url('kasbon/create');?>" class="btn btn-primary">
                            <i class="fas fa-plus mr-2"></i>Ajukan Kasbon
                        </a>
                    </div>
                </div>
                <div class="card-body">
...
<?php foreach($kasbon as $row):?>
<div class="modal fade" tabindex="-1" role="dialog" id="detail<?= $row["id"];?>">
