        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="ml-auto">
                        <a class="btn btn-primary" href="<?= base_url("operator/lokasi/create");?>">
                                        ...
                                        <div class="d-flex">
                                            <div>
                                                <a class="btn btn-warning btn-sm mr-1"
                                                    href="<?= base_url("operator/lokasi/edit/").$row["id"];?>">
                                            ...
                                            <div>
                                                <button class="btn btn-danger btn-sm"
                                                    data-confirm="Hapus Data|Apakah anda yakin ingin menghapus data <?= $row['lokasi'];?> ini ?"
                                                    data-confirm-yes="window.location.href='<?= base_url("operator/lokasi/delete/").$row["id"];?>'">
