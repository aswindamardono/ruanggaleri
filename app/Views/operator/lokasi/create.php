                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3 font-weight-bold">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="jam_masuk" class="form-label">Jam Masuk
                                                (Menit)</label>
                                            <input type="time"
                                                ...
                                                value="<?= old('jam_masuk');?>">
                                            <small class="invalid-feedback">
                                                <?= !empty($rusak['jam_masuk']) ? validation_show_error('') : ''; ?>
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="jam_keluar" class="form-label">Jam Pulang
                                                (Menit)</label>
                                            <input type="time"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                name="sebelum_masuk" id="sebelum_masuk" value="<?= old('sebelum_masuk');?>">
                                            <small class="invalid-feedback">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                name="sebelum_pulang" id="sebelum_pulang" value="<?= old('sebelum_pulang');?>">
                                            <small class="invalid-feedback">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                name="setelah_pulang" id="setelah_pulang" value="<?= old('setelah_pulang');?>">
                                            <small class="invalid-feedback">
...
<script>
var map = L.map('maps').setView([<?= $setting['lat'];?>, <?= $setting['long'];?>], 17);
var titleMap = " <?= $setting['address'];?>";
